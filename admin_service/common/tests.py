        ...
        self.assertEqual(
            actual,
            {
                ...
                "Комунікації": [
                    ...
                    "Розсилки",
                    "Опитування",
                    "Recovery 90 днів за 1 грн",
                    "Теми push-сповіщень",
                    "Історія повідомлень",
                ],
                "Підтримка": ["Звернення користувачів", "Відгуки користувачів"],
                "Система": ["Стан сервісів", "Помилки бота", "Події бота", "Журнал дій адміністраторів"],
                "Керування": ["Налаштування бота", "Адміністратори", "Сповіщення для адміністраторів"],
            },
        )
